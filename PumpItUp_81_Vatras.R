...
datIncl <- datIncl[,c(1:35, 37, 36)] #reorder
...
#nameData <- c("concurso_37vars_rf_3class_samp100_n5_grid5_nobalan__81.44__"); 
...
write.table(datSuboend, file=paste("Res_xxxx_rf_",numvars,"_samp100_noban_n",samp,"_Acc", rfAcc,"_",timval,".csv",sep=""),sep=","
