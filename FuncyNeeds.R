...
write.table(datSuboend, file=paste("Res_xxxx_", modtype,"_Func-Needs_",numvars,"_nere_",lim_nere,"_nofu_",lim_nofu,"_samp",samp,"_Acc_", scortmp,"_Err_",sumEr,"_",timval,".csv",sep=""),sep=","
